module VCAP::CloudController
  class BaseAccess
    ...
    def update_related_object?(object, params=nil)
    ...
    def read_related_object_for_update_with_token?(_)
      read_for_update_with_token?(_)
    end
    ...
    def update_related_object_with_token?(_)
      update_with_token?(_)
    end
