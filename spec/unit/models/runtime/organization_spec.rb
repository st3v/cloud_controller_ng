...
module VCAP::CloudController
  describe Organization, type: :model do
    ...
    describe 'Validations' do
      ...
      describe '#validate_remove_billing_manager_by_guid!' do
        context 'when the org has at least one extra billing_manager' do
          before do
          ...
          it 'is fine' do
            expect {
              org.validate_remove_billing_manager_by_guid!(12345)
            }.not_to raise_error
          end
        end

        context 'when the org has only one billing_manager' do
          it 'raises an ApiError' do
            expect {
              org.validate_remove_billing_manager_by_guid!(12345)
            }.to raise_error(CloudController::Errors::ApiError, /Cannot remove last Billing Manager in org/)
          end
        end
      end

      describe '#validate_remove_manager_by_guid!' do
        context 'when the org has at least one extra manager' do
          before do
          ...
          it 'is fine' do
            expect {
              org.validate_remove_manager_by_guid!(12345)
            }.not_to raise_error
          end
        end

        context 'when the org has only one manager' do
          it 'raises an ApiError' do
            expect {
              org.validate_remove_manager_by_guid!(12345)
            }.to raise_error(CloudController::Errors::ApiError, /Cannot remove last Org Manager in org/)
          end
        end
      end

      describe '#validate_remove_user_by_guid!' do
        context 'when the org has at least one extra user' do
          before do
          ...
          it 'is fine' do
            expect {
              org.validate_remove_user_by_guid!(12345)
            }.not_to raise_error
          end
        end

        context 'when the org has only one user' do
          it 'raises an ApiError' do
            expect {
              org.validate_remove_user_by_guid!(12345)
            }.to raise_error(CloudController::Errors::ApiError, /Cannot remove last user in org/)
          end
        end
      end
    end
